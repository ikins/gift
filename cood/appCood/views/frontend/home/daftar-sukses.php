                ...
                <div class="row padding-30">
                  <div class="col-md-12">
                      <div class="content-box text-center">
                        ...
                        <br>
                        <h4 class="text-red">Anda berhasil mendaftar, segera periksa email Anda untuk melakukan verifikasi email. <br> (kami sudah mengirimkan email, periksa inbox/spam)</h4>
                      </div>
